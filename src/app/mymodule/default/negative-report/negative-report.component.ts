...
export class NegativeReportComponent {
    ...
    getReportList():void{
      ...
      var api = `/api/reportList?page=${this.pageIndex}&pageSize=${this.pageSize}&startTime=${this.start_unix_time}&endTime=${this.end_unix_time}&type=-1`;
